...
// in ordinals_sdk/test/brc20_service_test.dart.
...
import 'package:ordinals_sdk/src/core/transaction_broadcaster.dart' as _i10;
...
/// A class which mocks [TransactionBroadcaster].
///
/// See the documentation for Mockito's code generation for more information.
class MockTransactionBroadcaster extends _i1.Mock
    implements _i10.TransactionBroadcaster {
  MockTransactionBroadcaster() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i8.Future<String> broadcast(String? rawTxHex) => (super.noSuchMethod(
        Invocation.method(
          #broadcast,
          [rawTxHex],
        ),
